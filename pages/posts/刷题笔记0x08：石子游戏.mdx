...
另外还可以发现，类似i == 1, j == 3和i == 3, j == 1的情况，它们表示的是同样的区间，所以我们可以抛弃表格左下角，并假定0 <= i <= size && i <= j <= size，其中size表示题目给定的数组长度。
...
![img](https://pic2.zhimg.com/v2-7da95293ed9e55c03ab41084ba3ed8c5_b.jpg)