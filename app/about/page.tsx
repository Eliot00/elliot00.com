  ...
  return (
    <article className={COMMON_PROSE_CLASS_NAME}>
      ...
      <p>
        ...
        <ExternalLink href="https://github.com/Eliot00/elliot00.com">
          Github代码仓库
        </ExternalLink>
        查看变更历史。
      </p>
      ...
      <ul>
        <li>NextJS</li>
        <li>
          <ExternalLink href="https://codeberg.org/Elliot00/docube">
            docube
          </ExternalLink>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <ExternalLink href="https://www.dusaiphoto.com/">
            杜塞的个人网站
          </ExternalLink>
        </li>
        <li>
          <ExternalLink href="https://jackyfzh.github.io/">
            Jacky的个人网站
          </ExternalLink>
        </li>
      </ul>
